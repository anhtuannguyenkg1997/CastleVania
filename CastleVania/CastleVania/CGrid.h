...
public:
	...
	void AddObjectCell(CObjectCell* unit);


	//Lấy các Object gán vào từng list phù hợp
	void GetListObject(vector<CObjectCell*> &listObjectCells, vector<LPGAMEOBJECT> &listObjects, vector<LPGAMEOBJECT> &listObjectsRender);

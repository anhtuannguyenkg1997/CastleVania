...
//COUNTER
#define NUM_SW_NORMAL	  1							//Số lượng vũ khí phụ tối đa ban đầu
#define NUM_SW_DOUBLESHOT 2							//Số lượng vũ khí phụ tối đa khi dùng DoubleShot
#define NUM_SW_TRIPLESHOT 3							//Số lượng vũ khí phụ tối đa khi dùng TripleShot

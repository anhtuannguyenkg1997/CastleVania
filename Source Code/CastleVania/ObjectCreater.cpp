...
void ObjectCreater::CreateObject(vector<string> tokens, Simon*& simon, MorningStar*& morningStar, bool resetBySimonDead, D3DXVECTOR2 simonPositionStart, int simonState, int simonOrientation) {
